...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Shape</h1>
    <ul class="breadcrumb">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">{{count($collection)}} Shapes</h5>
        </div>
        <div class="card-body">
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a id="" class="btn btn-primary btn-sm"
                                        href="{{ route('shapes.edit',$item->id) }}" role="button">Edit</a>
                                    <form action="{{ route('shapes.destroy',$item->id) }}" method="POST" class="ml-2">
                                        @csrf
                                        @method('DELETE')
