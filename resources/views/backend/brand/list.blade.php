...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">{{count($collection)}} Brands</h5>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a id="" class="btn btn-primary btn-sm" href="{{ route('brands.edit',$item->id) }}"
                                        role="button">Cập Nhật</a>
                                    <form action="{{ route('brands.destroy',$item->id) }}" method="POST" class="ml-2">
                                        @csrf
                                        @method('DELETE')
